...
Dzgaboard is a fork based on Domoboard https://github.com/wez3/Domoboard. 
...
Modify the config file to suit your needs. Start Dzgaboard by executing:
...
Please note that if you are running Dzgaboard on ports <= 1024 a user with permissions needs to be specified (User and Group under [Service]). Otherwise Dzgaboard cannot bind to the port due to a permission denied error. Dzgaboard writes an logfile to "logs/Dzgaboard.log". This logfile contains all messages generated by Dzgaboard which can be useful for troubleshooting issues.
...
Special thanks to https://github.com/wez3/Domoboard for developing Domoboard.
